class MilitaryInfantry{
  constructor(x, y, configs) {
    ...
    **/
    ...
    /**don vi nay da hoat dong turn nay chua**/
    this.active = true;
    ...
    this.landExplo = Advwar.game.add.sprite(this.sprite.body.position.x, this.sprite.body.position.y, 'landExplo');
    this.landExplo.animations.add('landExplos');
    this.landExplo.visible = false;

    this.muzzle = Advwar.game.add.sprite(this.sprite.body.position.x, this.sprite.body.position.y, 'muzzle');
